...
`study.git/프론트/NextJS_React/패턴_모범사례/React_제어_역전_컴포넌트_패턴.md` 참고!

`monorepo-nodejs20.git/packages/ui`  
`monorepo-nodejs20.git/apps/nextjs14/src/common/components`
